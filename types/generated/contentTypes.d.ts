...
export interface ApiCardLandingPageCardLandingPage
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerSection: Schema.Attribute.Component<'shared.footer-section', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiHeaderHeader extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    headerSection: Schema.Attribute.Component<'shared.header-section', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
  ...
  attributes: {
    ...
    pageBody: Schema.Attribute.DynamicZone<
      [
        ...
        'shared.description',
        'shared.cta',
        'cards.icon-card-section',
        'cards.information-card-section',
        'cards.product-card-section',
      ]
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::card-landing-page.card-landing-page': ApiCardLandingPageCardLandingPage;
